...
public final class FeatureFlagServiceGrpc {
   ...
   */
  public static FeatureFlagServiceBlockingV2Stub newBlockingV2Stub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<FeatureFlagServiceBlockingV2Stub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<FeatureFlagServiceBlockingV2Stub>() {
        @java.lang.Override
        public FeatureFlagServiceBlockingV2Stub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
          return new FeatureFlagServiceBlockingV2Stub(channel, callOptions);
        }
      };
    return FeatureFlagServiceBlockingV2Stub.newStub(factory, channel);
  }
   ...
   */
  public static final class FeatureFlagServiceBlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<FeatureFlagServiceBlockingV2Stub> {
    private FeatureFlagServiceBlockingV2Stub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected FeatureFlagServiceBlockingV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new FeatureFlagServiceBlockingV2Stub(channel, callOptions);
    }
  ...
  /**
   * A stub to allow clients to do limited synchronous rpc calls to service FeatureFlagService.
   */
